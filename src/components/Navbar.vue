...
// Cref para guardar o ID da seção ativa
const activeSection = ref('')

// lista de IDs das suas seções
const sectionIds = ['hero', 'sobre', 'habilidades', 'projetos', 'contato', 'blogue']
...
onMounted(() => {
  ...
  // 8. Diga ao observador quais seções ele deve "assistir"
...
// 9. Limpe o observador quando o componente for "destruído"
onBeforeUnmount(() => {
  if (observer) {
    observer.disconnect()
  }
...
<template>
  <div class=" navbar bg-base-200 shadow-lg fixed z-50 bg-opacity-80 backdrop-blur-sm">
    <div class="navbar-start">
      <a href="#home" class="text-2xl font-bold ml-6" style="font-size: 18px;">
        <span class="">Kelvin Junior</span>
        <!------- &lt;github /&gt;
    ...
    <div class="navbar-end space-x-2">
     ...
     <!--- <div class="dropdown dropdown-end ml-0">
        ...
        <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-32">
          <li><a href="#" class="active">🇧🇷 Português (PT)</a></li>
          <li><a href="#">🇺🇸 English (EN)</a></li>
          <li><a href="#">🇫🇷 Français (FR)</a></li>
        </ul>
      </div>---->

      <a href="https://wa.me/+33753282632" target="_blank" class="hidden mr-3 ml-1 md:flex">
      ...
      <a href="https://github.com/kelvinjunior77" target="_blank" class="hidden md:flex ml-0">
        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" class="bi bi-github"
          viewBox="0 0 16 16">
          <path
      ...
      <div class="dropdown dropdown-end lg:hidden">
        ...
        <ul tabindex="0" class="menu menu-md dropdown-content mt-3 z-[1] p-4 shadow bg-base-100 rounded-box w-64">
          ...
          <div class="flex justify-center space-x-6 py-2 mb-3 border-b border-base-200">
            ...
            <a href="https://wa.me/+33753282632" target="_blank" class="text-base-content hover:text-success">
